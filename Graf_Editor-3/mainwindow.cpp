...
void MainWindow::on_action_Suchen_triggered()
{
    ...
    DlgSuchen_Ersetzen *dialog = new DlgSuchen_Ersetzen(this, false, ui->textEdit);
    dialog->show();
...
void MainWindow::on_action_Ersetzen_triggered()
{
    ...
    DlgSuchen_Ersetzen *dialog = new DlgSuchen_Ersetzen(this, true, ui->textEdit);
    dialog->show();
}
...
void MainWindow::on_action_Hintergrund_triggered()
{
    //Dialog zur Farbeinstellung öffnen
    QColor color = QColorDialog::getColor();
    //Einstellung zu textedit übertragen
