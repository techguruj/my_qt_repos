...
Widget_copy::Widget_copy(QWidget *parent)
    : QWidget(parent)
...
void Widget_copy::on_btnFirst_clicked()
{
    _currentrecord = 1;
    query->first();
    refreshUi();
...
void Widget_copy::on_btnPrevious_clicked()
{
    query->previous();
    _currentrecord--;
    if(_currentrecord <= 0)
...
void Widget_copy::on_btnNext_clicked()
{
    query->next();
    _currentrecord++;
...
void Widget_copy::on_btnLast_clicked()
{
    query->last();
...
void Widget_copy::on_btnNew_clicked()
{
    ui->leMNr       ->clear();
...
void Widget_copy::on_btnSave_clicked()
{
...
void Widget_copy::on_btnCancel_clicked()
{
    refreshUi();
...
void Widget_copy::on_leMName_textChanged(const QString &arg1)
{
    switchButtons(TastenKombi::edit);
}


void Widget_copy::on_leMVorname_textChanged(const QString &arg1)
{
    switchButtons(TastenKombi::edit);
}
...
void Widget_copy::switchButtons(TastenKombi kombi)
{
    int k = (int) kombi;
    switchButtonsOff();
...
void Widget_copy::switchButtonsOff()
{
